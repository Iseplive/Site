...
class Administration_Controller extends Controller {
	...
	public function usersPage($param){
		...
		*/
		if(isset($_FILES['uploadxml1']) && $_FILES['uploadxml1']['name']!=null ){
			...
			//On d�place le fichier vers le serveur
	...
	public function isepdorPage($param){
			...
			/* Code qui met � jour le questionnaire pour les ISEP D'or
			*
			*/
			...
			/*Code qui met � jour la table isepdor_employees
			*
			*/
			...
			/*Code qui met � jour la table isepdor_event
			*
			*/
			...
			/*Code qui met � jour les date de vote des isep d'or
			*
			*/
			...
			*/
			if(isset($_GET['getDiplome'])){
				...
				$files=Array();
				$positions=json_decode($positions,true);//r�cupere les coordonn�es pr�c�dament demand�es
			...
			/*Code qui export les r�sultats des isep d'or
			*
			*/
				if(isset($_GET['export'])){
				 ...
				 header('Content-Disposition: filename='.'R�sultats_Isepdor'.'.xls');
				 ...
				 print '<table border=1 >
						<!-- impression des titres de colonnes -->
							<TR>
								...
								<TD bgcolor="#3366CC">Cat�gorie</TD>
								<TD bgcolor="#3366CC">R�ponse(student)</TD>
								<TD bgcolor="#3366CC">R�ponse(admin)</TD>
								<TD bgcolor="#3366CC">R�ponse(assoce)</TD>
								<TD bgcolor="#3366CC">R�ponse(event)</TD>						
							</TR>
							';
			...
			*/
			...
			/*Code qui met supprime les champs de la table r�sultat des isep d'or
			*
			*/
	...
	//Fonction qui formate nom et pr�nom pou en faire un username
